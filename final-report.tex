...
\end{figure}
Figure~\ref{fig:v5.3-portfolio-dev} illustrates the enhanced strategy's compounding trajectory 
on the Dev split, reaching \$316,452 from initial capital of \$100,000 (247.65\% return). 
The portfolio demonstrates disciplined drawdown management with maximum peak-to-trough decline 
limited to -22.10\%, substantially below the baseline's -35.42\%.
...
validation Sharpe of 1.84 (vs.\ 0.41 baseline), with maximum drawdown of only -12.49\% 
(vs.\ -35.42\% baseline).
