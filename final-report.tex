...
The enhanced strategy (v5.4) was evaluated on the held-out Val split (2018--2024) after all hyperparameter tuning was completed on the Dev split. Three OOS windows in WFO v2 produced negative Sharpe: 2008 ($-2.18$), 2011 ($-0.61$), 2015 ($-0.35$). The 2008 GFC result is structurally unavoidable for any lookback-based indicator. The 2011 and 2015 cases reflect range-bound years where momentum signals fire but mean-revert within the holding period---failure modes consistent across all lookback-based momentum strategies.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{./figures/v5.3_dev-portfolio.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{./figures/v5.3_val-portfolio.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{./figures/v5.3_baselineVSenhanced.png}
